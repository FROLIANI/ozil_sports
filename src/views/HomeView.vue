  ...
  <section id="billboard" class="bg-light py-5">
    <div class="container">
      <div class="row justify-content-center">
        ...
        >
          <p>
            Ozil-Sports unveils its latest collections, a fusion of cutting-edge
            performance wear and striking, contemporary designs. This new line
            of jerseys caters to athletes and fans alike, boasting advanced
            moisture-wicking fabrics for peak comfort and durability. Expect
            bold color palettes, sleek silhouettes, and meticulously crafted
            details that reflect the spirit of modern sports. Whether you're
            hitting the field or cheering from the stands, Ozil-Sports' new
            collections offer a perfect blend of style and functionality,
        ...
        <div class="col-md-8 py-5 my-5">
          <div class="subscribe-header text-center pb-3">
            <h3 class="section-title text-uppercase">
              Sign Up for our Updates of New Jerseys
            </h3>
          </div>
